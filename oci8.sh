...
unzip v1.4.zip
rm v1.4.zip
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=19W-zuCs4PIjy8vgkKeQI4p8oYoPm1s-m' 'oracle-instantclient18.5-basic-18.5.0.0.0-3.x86_64.rpm'
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=1pJtNh9SlGBw-EHqmPvQH28kpEOmKFlFU' 'oracle-instantclient18.5-devel-18.5.0.0.0-3.x86_64.rpm'
rm -r gdown.pl-1.4
