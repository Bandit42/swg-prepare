...
wget https://github.com/Bandit42/gdown.pl/archive/v1.4.zip
unzip v1.4.zip
rm v1.4.zip
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=1PD1cmnCK-Egw6h4fAPC8kAG5zxiXgKMm' 'LINUX.X64_180000_db_home.zip'
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=17rkCk_9L0yxcS7AqoUMnwIqZO2SZ5xIT' 'oracle-instantclient12.2-basiclite-12.2.0.1.0-1.i386.rpm'
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=1mn4jyaGiV_VZv6z5YUujo8ahKWGpoXXA' 'oracle-instantclient12.2-devel-12.2.0.1.0-1.i386.rpm'
./gdown.pl-1.4/gdown.pl 'https://drive.google.com/open?id=1shPfHduA2hB2WiaoAC9yhgwSuu323lHI' 'oracle-instantclient12.2-sqlplus-12.2.0.1.0-1.i386.rpm'
rm -r gdown.pl-1.4
